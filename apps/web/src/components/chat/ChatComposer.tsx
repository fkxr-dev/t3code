...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  useEffect(() => {
    ...
    const uploadableFiles =
      maxFileAttachmentBytes === null
        ? []
        : composerFiles.filter((file) => file.sizeBytes <= maxFileAttachmentBytes);
    for (const attachment of [...composerImages, ...uploadableFiles]) {
  ...
  const attachmentSendBlocked = activePendingProgress === null && attachmentBlockReason !== null;
  ...
  const submitComposer = useCallback(
    (event?: { preventDefault: () => void }, dispatchMode?: ComposerDispatchMode) => {
      ...
      if (attachmentSendBlocked) {
        event?.preventDefault();
        setComposerSubmissionError(attachmentBlockReason);
        setThreadError(activeThreadId, attachmentBlockReason);
        return;
      }
      ...
      >
        ...
        >
          ...
          <ComposerPromptLengthValidation
            message={
              providerInputSubmissionError ?? composerSubmissionError ?? attachmentBlockReason
            }
          />
            ...
            >
              ...
              >
                ...
                <ComposerFooterPrimaryActions
                  ...
                  hasSendableContent={
                    composerSendState.hasSendableContent && !attachmentSendBlocked
                  }
